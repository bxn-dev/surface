...
mod tests {
    ...
    use surface_core::{
        normalize_target, AuthoritativeAxfrObservation, AxfrAttempt, AxfrOutcome,
        CertificateTransparencyCandidate, CertificateTransparencyObservation, CnameHop,
        DanglingCnameObservation, DanglingCnameStatus, DnsObservation, DnssecObservation,
        ...
        RelatedDomainsObservation, ScanConfiguration, ScanReport, SkippedCheck, SpfObservation,
        WildcardDnsObservation, WildcardDnsRecordType, WildcardDnsStatus,
    };
